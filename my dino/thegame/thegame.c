...
void Play();
void Set();
void CD();//Collision Detection碰撞判断
void RenderDino();
void RenderObstacle();
...
void Load()
{
	...
	Crouching_Surface = IMG_Load("images/Crouching.png");//下蹲
	Dino_menu_Surface = IMG_Load("images/Dino_menu.png");//目录时的dino
	Hit_Surface = IMG_Load("images/Hit.png");//撞到时的头部
	Restart_Surface = IMG_Load("images/Restart.png");//重开
	Road_Surface = IMG_Load("images/Road.png");//道路 动
	Running_Surface = IMG_Load("images/Running.png");//跑动 动
	Sun_Surface = IMG_Load("images/Sun.png");//太阳
